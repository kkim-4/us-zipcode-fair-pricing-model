...
# 1. SETUP
# Make sure this points to your folder. 
# We add a filter to ONLY look for the '-Data.csv' files, ignoring Metadata.
...
for file in sorted(files):
    ...
    # Precise Year Extraction: Find 4 digits that follow '20'
    # This avoids the '5' in '5Y'
    ...
    # Handles both '860Z200US00601' and '00601'
    ...
    # Group by ZIP and YEAR just in case there are duplicates in a single file
...
if not all_income_data:
    ...
    def project_income(group):
        ...
        # Linear trend based on all available years
